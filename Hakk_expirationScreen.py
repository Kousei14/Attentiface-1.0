...
from Hakk_licenseScreen import Login
...
class Expire:
    def __init__(self, root):
        ...
        self.bg_mainscreen = PhotoImage(file="bg_expiration.png")
        ...
        img1_inactive=Image.open(r"ICONS_2\renew_inactive.png")
        img1_inactive=img1_inactive.resize((177,89))

        img1_active=Image.open(r"ICONS_2\renew_active.png")
        ...
        def unpressed_renew(event):
                    button_renew.config(image=root.img1_active)
        button_renew=Button(root,image=root.img1_inactive,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="raised",activebackground="black")
        ...
        img3_inactive=Image.open(r"ICONS_2\enterKey_inactive.png")
        img3_inactive=img3_inactive.resize((177,89))

        img3_active=Image.open(r"ICONS_2\enterKey_active.png")
        ...
        def unpressed_student(event):
                    button_student.config(image=root.img3_active)
        button_student=Button(root,image=root.img3_inactive,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="raised",activebackground="black",command=self.activate)
