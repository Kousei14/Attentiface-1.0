...
class mainscreen:
    def __init__(self, root):
        ...
        self.bg_mainscreen = PhotoImage(file="bg_mainscreen.png")
        ...
        attentiface_banner=Image.open(r"ICONS_2\attentiface_banner.png")
        attentiface_banner=attentiface_banner.resize((230,67))

        root.attentiface_banner_img=ImageTk.PhotoImage(attentiface_banner)
        atteentiface_final=Button(root,image=root.attentiface_banner_img,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="sunken",activebackground="black")
        atteentiface_final.place(x=500,y=190,width=230,height=67)

        #button register

        img1_inactive=Image.open(r"ICONS_2\register_active.png")
        img1_inactive=img1_inactive.resize((230,67))

        img1_active=Image.open(r"ICONS_2\register_inactive.png")
        ...
        def unpressed_student(event):
                    button_student.config(image=root.img1_active)
        button_student=Button(root,image=root.img1_inactive,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="raised",activebackground="black",command=self.register)
        ...
        img2_inactive=Image.open(r"ICONS_2\face_scan_active.png")
        img2_inactive=img2_inactive.resize((230,67))

        img2_active=Image.open(r"ICONS_2\face_scan_inactive.png")
        ...
        def unpressed_face_scan(event):
                    button_face_scan.config(image=root.img2_active)
        button_face_scan=Button(root,image=root.img2_inactive,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="raised",activebackground="black",command=self.Choose_attendance)
        ...
        img3_inactive=Image.open(r"ICONS_2\photos_active.png")
        img3_inactive=img3_inactive.resize((230,67))

        img3_active=Image.open(r"ICONS_2\photos_inactive.png")
        ...
        def unpressed_photos(event):
                    button_photos.config(image=root.img3_active)
        button_photos=Button(root,image=root.img3_inactive,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="raised",activebackground="black",command=self.open_photos)
        ...
        img4_inactive=Image.open(r"ICONS_2\records_active.png")
        img4_inactive=img4_inactive.resize((230,67))

        img4_active=Image.open(r"ICONS_2\records_inactive.png")
        ...
        def unpressed_records(event):
                    button_records.config(image=root.img4_active)
        button_records=Button(root,image=root.img4_inactive,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="raised",activebackground="black",command=self.Attendance)
        ...
        img5_inactive=Image.open(r"ICONS_2\exit_active.png")
        img5_inactive=img5_inactive.resize((230,67))

        img5_active=Image.open(r"ICONS_2\exit_inactive.png")
        ...
        def unpressed_exit(event):
                    button_exit.config(image=root.img5_active)
        button_exit=Button(root,image=root.img5_inactive,bg="black",borderwidth=0,width=200,highlightthickness=0,height=200,bd=0,relief="raised",activebackground="black",command=self.exit)
