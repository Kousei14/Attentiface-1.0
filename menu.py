...
from choose_cam import Choose
from attendance import Attendance_screen
...
class mainscreen:
    def __init__(self, root):
        ...
        # Button register
        img1_inactive = Image.open(r"icons/register_inactive.png")
        img1_inactive = img1_inactive.resize((230, 67))

        img1_active = Image.open(r"icons/register_active.png")
        ...
        # Button face scan
        img2_inactive = Image.open(r"icons/face_scan_inactive.png")
        img2_inactive = img2_inactive.resize((230, 67))

        img2_active = Image.open(r"icons/face_scan_active.png")
        ...
        button_face_scan = Button(root, image=root.img2_inactive, bg="black", borderwidth=0, width=200,
                                  highlightthickness=0, height=200, bd=0, relief="raised", activebackground="black",
                                  command=self.Choose_attendance)
        ...
        # Button photos
        img3_inactive = Image.open(r"icons/photos_inactive.png")
        img3_inactive = img3_inactive.resize((230, 67))

        img3_active = Image.open(r"icons/photos_active.png")
        ...
        button_photos = Button(root, image=root.img3_inactive, bg="black", borderwidth=0, width=200,
                               highlightthickness=0, height=200, bd=0, relief="raised", activebackground="black",
        ...
        # Button records
        img4_inactive = Image.open(r"icons/records_inactive.png")
        img4_inactive = img4_inactive.resize((230, 67))

        img4_active = Image.open(r"icons/records_active.png")
        ...
        button_records = Button(root, image=root.img4_inactive, bg="black", borderwidth=0, width=200,
                                highlightthickness=0, height=200, bd=0, relief="raised", activebackground="black",
        ...
        # Button exit
        img5_inactive = Image.open(r"icons/exit_inactive.png")
        img5_inactive = img5_inactive.resize((230, 67))

        img5_active = Image.open(r"icons/exit_active.png")
    ...
    def open_photos(self):
        ...
        def load_images():
            ...
            for r in range(0, len(images_files)):
                images_list.append([
                    ImageTk.PhotoImage(Image.open(os.path.join(dir_path, images_files[r])).resize((50, 50),
                                                                                                Image.Resampling.LANCZOS)),
                    ImageTk.PhotoImage(Image.open(os.path.join(dir_path, images_files[r])).resize((500, 500),
                                                                                                Image.Resampling.LANCZOS))
                ])
